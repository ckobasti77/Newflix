...
import SerieSidebar from "./serie-sidebar";
...
const Serie = (serie: any) => {
    ...
    const [episodeSeasonId, setEpisodeSeasonId] = useState<any>(1)
    ...
    return (
        <div className="mx-auto">
            ...
            <div id="watch" className="flex gap-x-4 py-4">
                <SerieSidebar serie={serie} episodeSeasonId={episodeSeasonId} setEpisodeSeasonId={setEpisodeSeasonId} currentSeasonId={currentSeasonId} setCurrentSeasonId={setCurrentSeasonId} currentEpisodeId={currentEpisodeId} setCurrentEpisodeId={setCurrentEpisodeId} />
                <iframe
                    title="video"
                    id="ytplayer"
                    // @ts-ignore
                    ...
                    width="840"
                    height="450"
                    src={`https://moviesapi.club/tv/${serie.serie.id}-${episodeSeasonId}-${currentEpisodeId}`}
                    frameBorder="0"
